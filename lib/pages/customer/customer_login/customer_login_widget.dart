...
class CustomerLoginWidget extends StatefulWidget {
  ...
  @override
  State<CustomerLoginWidget> createState() => _CustomerLoginWidgetState();
}
...
class _CustomerLoginWidgetState extends State<CustomerLoginWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0x85272729),
        body: SafeArea(
          top: true,
          child: Row(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: const Color(0x85272729),
                                  boxShadow: const [
                                    BoxShadow(
                                      blurRadius: 4.0,
                                      color: Color(0xE86A6A6A),
                                      offset: Offset(
                                        4.0,
                                        6.0,
                                      ),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset(
                                          'assets/images/Screenshot_2024-05-03_at_3.03.30_AM.png',
                                          fit: BoxFit.contain,
                                        ),
                                      ),
                                    ),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Lottie.asset(
                                            'assets/lottie_animations/Animation_-_1714686552912.json',
                                            width: 150.0,
                                            height: 130.0,
                                            fit: BoxFit.cover,
                                            animate: true,
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            FFAppState().CustomerName = _model
                                                .customerNameTextController
                                                .text;
                                            FFAppState().CustomerEmail = _model
                                                .emailAddressTextController
                                                .text;
                                          });

                                          context
                                              .pushNamed('AddCustomerDetails');
                                        },
                                        text: 'Next',
